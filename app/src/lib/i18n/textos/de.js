...
export default {
  ...
  barrido: {
    ...
    descargandoLargo: 'Scan wird geladen…',
    pie: 'Abgeschlossene 1-Stunden-Kerzen, alle 30 Min. aktualisiert. Bildungsanalyse, keine Finanzberatung.',
