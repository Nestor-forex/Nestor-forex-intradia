...
export default {
  ...
  tablero: {
    ...
    limitaciones:
      'Velas de 1 hora con precio de cierre (sin máximo/mínimo intrabar real de la fuente): ATR, RSI y los puntos pivote se calculan sobre esos cierres, así que el pivote es una aproximación, no el máximo/mínimo real del día anterior. Sin datos de MT5 no hay tick volume ni spread real del bróker — la liquidez se estima cualitativamente.',
    ...
    pieParesGrafico: 'Gráfico y variación (%) sobre las últimas 20 velas H1. ATR: volatilidad proxy cierre-a-cierre por hora. Pivote/S1/R1: puntos pivote clásicos calculados con el máximo/mínimo/cierre de las 24 horas previas.',
    dif: 'Dif',
  ...
  calc_barrido: {
    ...
    slCompra: ' (bajo el mínimo de 10 horas − ½ ATR)',
    slVenta: ' (sobre el máximo de 10 horas + ½ ATR)',
